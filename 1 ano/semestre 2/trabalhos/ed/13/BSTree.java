...
public class BSTree<T extends Comparable<? super T>> {   
   ...
   // --------------------------------------------------------
   // Verifica se uma arvore e de pesquisa

   public boolean valid(){
      return valid(getRoot());
   }

   private boolean valid(BSTNode<T> n){
      if (n == null) return true;
      if (n.getLeft() != null && n.getRight() != null) return validLess(n.getLeft(),n.getValue())
       && validMore(n.getRight(),n.getValue()) && valid(n.getLeft()) && valid(n.getRight());
      if (n.getLeft() != null)  return validLess(n.getLeft(),n.getValue()) && valid(n.getLeft());
      return validMore(n.getRight(),n.getValue()) && valid(n.getRight());
   }

   private boolean validLess(BSTNode<T> n, T t){
      if (n == null) return true;
      if (n.getValue().compareTo(t) < 0) return validLess(n.getLeft(),t) && validLess(n.getRight(),t);
      //System.out.println(n.getValue() + " " + t);
      return false;
   }

   private boolean validMore(BSTNode<T> n, T t){
      if (n == null) return true;
      if (n.getValue().compareTo(t) > 0) return validMore(n.getLeft(),t) && validMore(n.getRight(),t);
      return false;
   }

   // --------------------------------------------------------
   // Contar elementos entre a e b de uma arvore de pesquisa
   // Devolve um inteiro
   public int countBetween(T a,T b){
      return countBetween(getRoot(),a,b);
   }
   ...
   private int countBetween(BSTNode<T> n, T a, T b){
     ...
     // if(n.getValue().compareTo(a) < 0) return 0 + countBetween(n.getRight() , a ,b);
      return 0 + countBetween(n.getLeft() , a ,b) + countBetween(n.getRight(), a, b);
   }
